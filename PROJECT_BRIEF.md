...
|--------|------|--------|-------|
| 0 | Infrastructure | 🔨 In Progress | VPS setup, Docker, Nginx, SSL, Icecast2 + Liquidsoap |
| 1 | Core Radio | ⬜ Planned | Live streaming, fallback, web player, health monitor, R2 archiver |
...
- Nothing deployed — Sprint 0 in progress

**What's next:**
- Sprint 0: Get Docker + Icecast2 + Liquidsoap + Nginx + SSL live on VPS
